	...
	_
{
		...
		final
	{
			...
			Clause_X_Clause
		{
			...
			static_assert(ExpectType<
				(p	or	q)	and	(!q	or	!p)
			,	And<Or <aP, aQ>, Or <nQ, nP>>
			>);
			static_assert(ExpectType<
				(p	or	q)	and	(!q	or	r)
			,	And<Or <aP, aQ>, Or <nQ, aR>>
			>);
			static_assert(ExpectType<
				(p	or	q)	and	(r	or	p)
			,	And<Or <aP, aQ>, Or <aR, aP>>
			>);
			static_assert(ExpectType<
				(p	or	q)	and	(r	or	!p)
			,	And<Or <aP, aQ>, Or <aR, nP>>
			>);
			static_assert(ExpectType<
				(p	or	q)	and	(r	or	q)
			,	And<Or <aP, aQ>, Or <aR, aQ>>
			>);
			static_assert(ExpectType<
				(p	or	q)	and	(r	or	!q)
			,	And<Or <aP, aQ>, Or <aR, nQ>>
			>);
			static_assert(ExpectType<
				(p	or	q)	and	(r	or	s)
			...
			static_assert(ExpectType<
				(p	or	q)	*	(!q	or	!p)
			,	Or <And<aP, nQ>, And<aQ, nP>>
			>);
			static_assert(ExpectType<
				(p	or	q)	*	(!q	or	r)
			,	Or <And<aP, nQ>, And<aQ, aR>>
			>);
			static_assert(ExpectType<
				(p	or	q)	*	(r	or	p)
			,	Or <aP, And<aQ, aR>>
			...
			static_assert(ExpectType<
				(p	and	q)	or	(!q	and	!p)
			,	Or <And<aP, aQ>, And<nQ, nP>>
			>);
			static_assert(ExpectType<
				(p	and	q)	or	(!q	and	r)
			,	Or <And<aP, aQ>, And<nQ, aR>>
			>);
			static_assert(ExpectType<
				(p	and	q)	or	(r	and	q)
			,	Or <And<aP, aQ>, And<aR, aQ>>
			>);
			static_assert(ExpectType<
				(p	and	q)	or	(r	and	!q)
			,	Or <And<aP, aQ>, And<aR, nQ>>
			>);
			static_assert(ExpectType<
				(p	and	q)	or	(r	and	p)
			,	Or <And<aP, aQ>, And<aR, aP>>
			>);
			static_assert(ExpectType<
				(p	and	q)	or	(r	and	!p)
			,	Or <And<aP, aQ>, And<aR, nP>>
			>);
			static_assert(ExpectType<
				(p	and	q)	or	(r	and	s)
			...
			static_assert(ExpectType<
				(p	and	q)	+	(!q	and	!p)
			,	And<Or <aP, nQ>, Or <aQ, nP>>
			>);
			static_assert(ExpectType<
				(p	and	q)	+	(!q	and	r)
			,	And<Or <aP, nQ>, Or <aQ, aR>>
			>);
			static_assert(ExpectType<
				(p	and	q)	+	(r	and	p)
			,	And<aP, Or <aQ, aR>>
