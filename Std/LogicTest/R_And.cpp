...
static_assert
(	(r	and	((p	or	q)	and	(p	or	r)))	==	((p	or	q)	and	r)
);
static_assert
(	(r	and	((p	or	q)	and	(!p	or	r)))	==	((p	or	q)	and	r)
);
static_assert
(	(r	and	((p	or	q)	and	(q	or	r)))	==	((p	or	q)	and	r)
);
static_assert
(	(r	and	((p	or	q)	and	(!q	or	r)))	==	((p	or	q)	and	r)
);
static_assert
(	(r	and	((p	or	q)	and	(r	or	p)))	==	((p	or	q)	and	r)
);
static_assert
(	(r	and	((p	or	q)	and	(r	or	!p)))	==	((p	or	q)	and	r)
);
static_assert
(	(r	and	((p	or	q)	and	(r	or	q)))	==	((p	or	q)	and	r)
);
static_assert
(	(r	and	((p	or	q)	and	(r	or	!q)))	==	((p	or	q)	and	r)
);
...
static_assert
(	(r	and	((p	or	q)	and	(r	or	s)))	==	((p	or	q)	and	r)
);
