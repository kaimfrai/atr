...
static_assert
(	(!r	and	((p	or	q)	and	(p	or	r)))	==	(p	and	!r)
);
static_assert
(	(!r	and	((p	or	q)	and	(!p	or	r)))	==	(!p	and	q	and	!r)
);
static_assert
(	(!r	and	((p	or	q)	and	(q	or	r)))	==	(q	and	!r)
);
static_assert
(	(!r	and	((p	or	q)	and	(!q	or	r)))	==	(p	and	!q	and	!r)
);
static_assert
(	(!r	and	((p	or	q)	and	(r	or	p)))	==	(p	and	!r)
);
static_assert
(	(!r	and	((p	or	q)	and	(r	or	!p)))	==	(!p	and	q	and	!r)
);
static_assert
(	(!r	and	((p	or	q)	and	(r	or	q)))	==	(q	and	!r)
);
static_assert
(	(!r	and	((p	or	q)	and	(r	or	!q)))	==	(p	and	!q	and	!r)
);

///	4 Literal Conjunction 2 x 2
static_assert
(	(!r	and	((p	or	q)	and	(r	or	s)))	==	((p	or	q)	and	!r	and	s)
);
