...
echo "virtual"
clang++-13 -std=c++2b -stdlib=libc++ -O3 -fmodules -fprebuilt-module-path=../build/clang-release/modules -fbuiltin-module-map -fmodules-cache-path=../build/clang-release/modules/cache -fmodule-map-file=../module.modulemap -frelaxed-template-template-args -S -masm=intel -fverbose-asm Virtual/Main.cpp -o ../build/assembly/virtual.s
echo "any"
clang++-13 -std=c++2b -stdlib=libc++ -O3 -fmodules -fprebuilt-module-path=../build/clang-release/modules -fbuiltin-module-map -fmodules-cache-path=../build/clang-release/modules/cache -fmodule-map-file=../module.modulemap -frelaxed-template-template-args -S -masm=intel -fverbose-asm Any/Main.cpp -o ../build/assembly/any.s
echo "dyno"
clang++-13 -std=c++2b -stdlib=libc++ -O3 -fmodules -fprebuilt-module-path=../build/clang-release/modules -fbuiltin-module-map -fmodules-cache-path=../build/clang-release/modules/cache -fmodule-map-file=../module.modulemap -frelaxed-template-template-args -S -masm=intel -fverbose-asm Dyno/Main.cpp -o ../build/assembly/dyno.s
echo "polymorphic"
