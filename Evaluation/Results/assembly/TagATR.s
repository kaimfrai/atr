...
<L15>:
	vaddps
		zmm0, zmm0, zmmword ptr [r11 + 4*rbp - 0xc0]
	vaddps
		zmm1, zmm1, zmmword ptr [r11 + 4*rbp - 0x80]
	vaddps
		zmm2, zmm2, zmmword ptr [r11 + 4*rbp - 0x40]
	vaddps
		zmm3, zmm3, zmmword ptr [r11 + 4*rbp]
	add
		rbp, 0x40
	cmp
		r10, rbp
...
<L17>:
	vaddps
		ymm0, ymm0, ymmword ptr [rbp + 4*r10]
	add
		r10, 0x8
	cmp
		r11, r10
...
<L26>:
	...
	jmp
		<L29>
	vmovups
		ymmword ptr [r12 + rbx], ymm8
	vmovq
		qword ptr [r12 + rbx + 0x20], xmm7
	mov
		byte ptr [r8 + rsi], 0xb
	nop
		word ptr cs:[rax + rax]
...
<L30>:
	...
	vmovdqa
		xmmword ptr [rsp + 0x560], xmm10
	vmovdqa
		xmmword ptr [rsp + 0x570], xmm11
	vmovdqa
		xmmword ptr [rsp + 0x580], xmm12
	vmovdqa
		xmmword ptr [rsp + 0x590], xmm13
	vmovdqa
		xmmword ptr [rsp + 0x5a0], xmm14
	vmovdqa
	...
	vmovdqu
		ymmword ptr [rax], ymm7
	jmp
		<L27>
	vmovups
		ymmword ptr [r12 + rbx], ymm8
	vextractps
		dword ptr [r12 + rbx + 0x20], xmm7, 0x1
	mov
		byte ptr [r8 + rsi], 0x9
	jmp
		<L27>
