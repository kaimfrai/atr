...
<_start>:
               	...
               	xor	ecx, ecx
               	lea	rdi,  <main>
               	call	qword ptr  <__libc_start_main+0x8fd8>
               	hlt
               	int3
               	int3
               	int3
...
<deregister_tm_clones>:
               	...
               	cmp	rax, rdi
               	je	 <L0>
               	mov	rax, qword ptr  <__libc_start_main+0x8fe8>
               	test	rax, rax
               	je	 <L0>
               	jmp	rax
               	nop	dword ptr [rax]
...
<register_tm_clones>:
               	...
               	sar	rsi
               	je	 <L0>
               	mov	rax, qword ptr  <__libc_start_main+0x8ff0>
               	test	rax, rax
               	je	 <L0>
               	jmp	rax
...
<__do_global_dtors_aux>:
               	...
               	jne	 <L0>
               	push	rbp
               	cmp	qword ptr , 0x0 <__libc_start_main+0x8ff8>
               	mov	rbp, rsp
               	je	 <L1>
...
<L2>:
               	...
               	lea	rdi, [rcx + 8*rax]
               	mov	rsi, qword ptr  <__libc_start_main+0x9000>
               	...
               	vpaddq	ymm2, ymm0, ymmword ptr  <__libc_start_main+0x1260>
               	...
               	vpbroadcastq	ymm1, qword ptr  <__libc_start_main+0x12c0>
               	vpmuludq	ymm1, ymm0, ymm1
               	vpsrlq	ymm2, ymm0, 0x20
               	vpbroadcastq	ymm3, qword ptr  <__libc_start_main+0x12a8>
               	...
               	vpxor	ymm0, ymm1, ymm0
               	vpbroadcastq	ymm1, qword ptr  <__libc_start_main+0x12b0>
               	vpmuludq	ymm1, ymm0, ymm1
               	vpsrlq	ymm2, ymm0, 0x20
               	vpbroadcastq	ymm3, qword ptr  <__libc_start_main+0x12b8>
               	vpmuludq	ymm2, ymm2, ymm3
               	vpaddq	ymm1, ymm1, ymm2
               	vpsllq	ymm1, ymm1, 0x20
               	vpmuludq	ymm0, ymm0, ymm3
...
<L230>:
               	...
               	xor	ebp, ebp
               	mov	edi, 0x1
               	vpbroadcastq	ymm6, qword ptr  <__libc_start_main+0x12a0>
               	vpbroadcastw	xmm7, word ptr  <__libc_start_main+0x12e0>
               	lea	r8,  <__libc_start_main+0x12e4>
               	mov	r9, rcx
...
<L233>:
               	...
               	vandps	ymm1, ymm1, ymmword ptr  <__libc_start_main+0x1280>
               	mov	byte ptr [r13 + r15], 0xc
               	vmovups	ymmword ptr [r9 + 8*rbx + 0x8], ymm0
               	mov	rax, qword ptr [r9 + 8*rbx]
               	vcvtdq2ps	ymm0, ymm1
...
<L234>:
               	...
               	lea	rax,  <__libc_start_main+0x1318>
...
<L256>:
               	...
               	vucomiss	xmm0, dword ptr  <__libc_start_main+0x12d8>
               	je	 <L245>
               	mov	edi, 0x4
               	vzeroupper
               	...
               	mov	rsi, qword ptr  <__libc_start_main+0x9008>
               	mov	rdi, rax
               	xor	edx, edx
...
<L245>:
               	...
               	vmulss	xmm0, xmm0, dword ptr  <__libc_start_main+0x12cc>
               	jmp	 <L257>
               	vmovss	xmm0, dword ptr [rdx + 0x1c] # xmm0 = mem[0],zero,zero,zero
<L262>:
               	vmulss	xmm0, xmm0, dword ptr  <__libc_start_main+0x12cc>
<L258>:
               	...
               	jmp	 <L257>
               	vmovss	xmm0, dword ptr [rdx + 0x1c] # xmm0 = mem[0],zero,zero,zero
               	vmulss	xmm0, xmm0, dword ptr  <__libc_start_main+0x12d4>
               	jmp	 <L258>
               	mov	r9d, edi
               	vmovss	xmm0, dword ptr [rdx + 0x1c] # xmm0 = mem[0],zero,zero,zero
               	...
               	jmp	 <L260>
               	vmovss	xmm0, dword ptr [rdx + 0x1c] # xmm0 = mem[0],zero,zero,zero
               	vmulss	xmm0, xmm0, dword ptr  <__libc_start_main+0x12d0>
<L263>:
               	vmulss	xmm0, xmm0, dword ptr [rdx + 0x20]
<L260>:
               	mov	r9d, edi
               	...
               	vmovss	xmm0, dword ptr [rdx + 0x1c] # xmm0 = mem[0],zero,zero,zero
               	vmulss	xmm0, xmm0, xmm0
               	vmulss	xmm0, xmm0, dword ptr  <__libc_start_main+0x12c8>
               	jmp	 <L258>
               	vmovss	xmm0, dword ptr [rdx + 0x1c] # xmm0 = mem[0],zero,zero,zero
               	vmulss	xmm0, xmm0, dword ptr  <__libc_start_main+0x12dc>
               	jmp	 <L263>
               	mov	r9d, edi
               	vmovss	xmm0, dword ptr [rdx + 0x24] # xmm0 = mem[0],zero,zero,zero
<L261>:
               	vmulss	xmm1, xmm0, xmm0
               	vmulss	xmm1, xmm1, dword ptr  <__libc_start_main+0x12dc>
<L259>:
...
<_init>:
               	endbr64
               	sub	rsp, 0x8
               	mov	rax, qword ptr  <__libc_start_main+0x8fe0>
               	test	rax, rax
               	je	 <L0>
               	call	rax
<L0>:
