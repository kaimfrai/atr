...
<_start>:
               	...
               	xor	ecx, ecx
               	lea	rdi,  <main>
               	call	qword ptr  <__libc_start_main+0x8fb0>
               	hlt
               	int3
               	int3
               	int3
...
<deregister_tm_clones>:
               	...
               	cmp	rax, rdi
               	je	 <L0>
               	mov	rax, qword ptr  <__libc_start_main+0x8fc0>
               	test	rax, rax
               	je	 <L0>
               	jmp	rax
               	nop	dword ptr [rax]
...
<register_tm_clones>:
               	...
               	sar	rsi
               	je	 <L0>
               	mov	rax, qword ptr  <__libc_start_main+0x8fc8>
               	test	rax, rax
               	je	 <L0>
               	jmp	rax
...
<__do_global_dtors_aux>:
               	...
               	jne	 <L0>
               	push	rbp
               	cmp	qword ptr , 0x0 <__libc_start_main+0x8fd0>
               	mov	rbp, rsp
               	je	 <L1>
...
<L2>:
               	...
               	lea	rdi, [rcx + 8*rax]
               	mov	rsi, qword ptr  <__libc_start_main+0x8fd8>
...
<L230>:
               	...
               	vpbroadcastw	xmm7, word ptr  <__libc_start_main+0x12c8>
               	lea	rdi,  <__libc_start_main+0x12cc>
...
<L233>:
               	...
               	vpmovzxbd	ymm0, qword ptr [rsp + 0x380] # ymm0 = mem[0],zero,zero,zero,mem[1],zero,zero,zero,mem[2],zero,zero,zero,mem[3],zero,zero,zero,mem[4],zero,zero,zero,mem[5],zero,zero,zero,mem[6],zero,zero,zero,mem[7],zero,zero,zero
               	vmovups	ymm1, ymmword ptr [rsp + 0x2e8]
               	vmovups	ymm2, ymmword ptr [rsp + 0x2f8]
               	vinsertf128	ymm1, ymm1, xmmword ptr [rsp + 0x308], 0x1
               	vinsertf128	ymm2, ymm2, xmmword ptr [rsp + 0x318], 0x1
               	vcvtdq2ps	ymm0, ymm0
               	vshufps	ymm1, ymm1, ymm2, 0x88  # ymm1 = ymm1[0,2],ymm2[0,2],ymm1[4,6],ymm2[4,6]
               	vmovdqu	ymm2, ymmword ptr [rsp + 0x360]
               	vandps	ymm1, ymm1, ymmword ptr  <__libc_start_main+0x1260>
               	mov	rax, qword ptr [rsp + 0x358]
               	mov	byte ptr [r13 + rax], 0xc
               	vmovups	ymmword ptr [r12 + 8*rbx + 0x8], ymm0
               	mov	rax, qword ptr [r12 + 8*rbx]
               	mov	ebx, dword ptr [rsp + 0x234]
...
<L234>:
               	...
               	mov	rdx, r13
               	vzeroupper
               	call	 <auto Bodies3D::TransformReduce@Evaluation.Dependency.TransformReduce<Bodies3D::Body3DIterator@Evaluation.Dependency.TaggedArray<Bodies3D::Interface@Evaluation.TagATR.Interface>, Bodies3D::Body3DIterator@Evaluation.Dependency.TaggedArray<Bodies3D::Interface@Evaluation.TagATR.Interface>, ComputeVolumeSum(PseudoRandomSequence@Evaluation.Dependency.PseudoRandomSequence)::'lambda'(auto)>(auto, Bodies3D::Body3DIterator@Evaluation.Dependency.TaggedArray<Bodies3D::Interface@Evaluation.TagATR.Interface>, ComputeVolumeSum(PseudoRandomSequence@Evaluation.Dependency.PseudoRandomSequence)::'lambda'(auto))>
...
<L248>:
               	...
               	cmp	qword ptr [rsp + 0x260], rax
               	jne	 <L249>
               	vmovss	xmm0, dword ptr [rsp + 0x10] # xmm0 = mem[0],zero,zero,zero
               	vucomiss	xmm0, dword ptr  <__libc_start_main+0x12bc>
               	jb	 <L250>
               	vmovss	xmm0, dword ptr [rsp + 0x10] # xmm0 = mem[0],zero,zero,zero
               	vucomiss	xmm0, dword ptr  <__libc_start_main+0x12c4>
               	ja	 <L250>
<L249>:
               	xor	eax, eax
               	add	rsp, 0x3d8
...
<L250>:
               	...
               	mov	rsi, qword ptr  <__libc_start_main+0x8fe0>
               	mov	rdi, rax
               	xor	edx, edx
...
<auto Bodies3D::TransformReduce@Evaluation.Dependency.TransformReduce<Bodies3D::Body3DIterator@Evaluation.Dependency.TaggedArray<Bodies3D::Interface@Evaluation.TagATR.Interface>, Bodies3D::Body3DIterator@Evaluation.Dependency.TaggedArray<Bodies3D::Interface@Evaluation.TagATR.Interface>, ComputeVolumeSum(PseudoRandomSequence@Evaluation.Dependency.PseudoRandomSequence)::'lambda'(auto)>(auto, Bodies3D::Body3DIterator@Evaluation.Dependency.TaggedArray<Bodies3D::Interface@Evaluation.TagATR.Interface>, ComputeVolumeSum(PseudoRandomSequence@Evaluation.Dependency.PseudoRandomSequence)::'lambda'(auto))>:
<L2>:
               	push	rbp
               	push	r15
               	push	r14
               	...
               	cmp	rcx, 0x28
               	jae	 <L0>
               	vmovss	xmm2, dword ptr  <__libc_start_main+0x12b8> # xmm2 = mem[0],zero,zero,zero
               	jmp	 <L1>
<L0>:
               	mov	r15, rdx
...
<L1>:
               	...
               	lea	rcx,  <__libc_start_main+0x1300>
               	...
               	jmp	 <L4>
               	vmovss	xmm0, dword ptr [rbx + 0x1c] # xmm0 = mem[0],zero,zero,zero
               	vmulss	xmm0, xmm0, dword ptr  <__libc_start_main+0x12c0>
               	jmp	 <L5>
               	vmovss	xmm0, dword ptr [rbx + 0x1c] # xmm0 = mem[0],zero,zero,zero
...
<L6>:
               	vmulss	xmm1, xmm0, xmm0
               	vmulss	xmm1, xmm1, dword ptr  <__libc_start_main+0x12c0>
<L8>:
...
<_init>:
               	endbr64
               	sub	rsp, 0x8
               	mov	rax, qword ptr  <__libc_start_main+0x8fb8>
               	test	rax, rax
               	je	 <L0>
               	call	rax
<L0>:
