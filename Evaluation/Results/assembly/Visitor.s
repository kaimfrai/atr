...
<_start>:
               	...
               	xor	ecx, ecx
               	lea	rdi,  <main>
               	call	qword ptr  <__libc_start_main+0x6ad0>
               	hlt
               	int3
               	int3
               	int3
...
<deregister_tm_clones>:
               	...
               	cmp	rax, rdi
               	je	 <L0>
               	mov	rax, qword ptr  <__libc_start_main+0x6ae0>
               	test	rax, rax
               	je	 <L0>
               	jmp	rax
               	nop	dword ptr [rax]
...
<register_tm_clones>:
               	...
               	sar	rsi
               	je	 <L0>
               	mov	rax, qword ptr  <__libc_start_main+0x6ae8>
               	test	rax, rax
               	je	 <L0>
               	jmp	rax
...
<__do_global_dtors_aux>:
               	...
               	jne	 <L0>
               	push	rbp
               	cmp	qword ptr , 0x0 <__libc_start_main+0x6af0>
               	mov	rbp, rsp
               	je	 <L1>
...
<L2>:
               	...
               	shl	rax, 0x4
               	lea	rdi, [rax + 2*rax]
               	mov	rsi, qword ptr  <__libc_start_main+0x6af8>
...
<L230>:
               	...
               	vpbroadcastw	xmm7, word ptr  <__libc_start_main+0xb00>
               	lea	r11,  <__libc_start_main+0xb04>
               	vmovaps	ymm8, ymmword ptr  <__libc_start_main+0xa80>
               	vpbroadcastq	xmm9, qword ptr  <__libc_start_main+0xab0>
               	mov	r12, qword ptr [rsp + 0x218]
...
<L238>:
               	...
               	vmovdqu	ymm1, ymmword ptr [rsp + 0x268]
               	vmovdqu	ymm2, ymmword ptr [rsp + 0x2a8]
               	vmovdqu	ymm3, ymmword ptr [rsp + 0x2c8]
               	vmovdqu	ymm4, ymmword ptr [rsp + 0x2e8]
               	vpsrlq	ymm1, ymm1, 0x8
               	vmovdqu	ymmword ptr [rsp + 0x268], ymm1
               	vpsrlq	ymm0, ymm0, 0x8
               	vmovdqu	ymmword ptr [rsp + 0x288], ymm0
               	vpsrlq	ymm0, ymm2, 0x8
               	vmovdqu	ymmword ptr [rsp + 0x2a8], ymm0
               	vpsrlq	ymm0, ymm3, 0x8
               	vmovdqu	ymmword ptr [rsp + 0x2c8], ymm0
               	vpsrlq	ymm2, ymm4, 0x8
               	vmovdqu	ymmword ptr [rsp + 0x2e8], ymm2
               	vmovq	rax, xmm1
...
<L233>:
               	...
               	vmovdqu	ymm10, ymmword ptr [rsp + 0x290]
               	movzx	ecx, al
               	imul	ecx, ecx, 0x4f
               	shr	ecx, 0xa
               	lea	edx, [rcx + 2*rcx]
               	...
               	vmovdqu	xmm0, xmmword ptr [rsp + 0x2b0]
               	...
               	lea	rax, [rsi + 2*rsi]
               	shl	rax, 0x4
               	mov	qword ptr [r12 + rax + 0x20], 0x0
               	...
               	lea	rcx,  <Visitor::ObjectReference@Evaluation.Dependency.Visitor.ObjectReference Visitor::ObjectValue@Evaluation.Dependency.Visitor.ObjectValue<40ul, (std::align_val_t)8>::Access<Bodies3D::Ellipsoid@Evaluation.CRTP.Ellipsoid>(void*)>
               	mov	qword ptr [r12 + rax + 0x28], rcx
               	inc	rsi
               	vmovss	dword ptr [r12 + rax + 0x20], xmm1
               	...
               	vmovdqu	ymmword ptr [rsp + 0x330], ymm4
               	vmovdqu	ymmword ptr [rsp + 0x360], ymm10
               	...
               	vmovdqu	ymmword ptr [r12 + rcx + 0x8], ymm0
               	...
               	mov	qword ptr [r12 + rcx + 0x28], rdx
               	inc	rsi
               	...
               	vmovdqu	xmm1, xmmword ptr [rsp + 0x2c0]
               	vpshufb	xmm1, xmm1, xmmword ptr  <__libc_start_main+0xae0>
               	vcvtdq2ps	xmm1, xmm1
               	movzx	ecx, byte ptr [rsp + 0x308]
               	...
               	vmovups	xmm3, xmmword ptr [rsp + 0x2d8]
               	vshufps	xmm3, xmm3, xmmword ptr [rsp + 0x2e8], 0x88 # xmm3 = xmm3[0,2],mem[0,2]
...
<L242>:
               	...
               	vcvtdq2ps	xmm0, xmm0
               	vmovlps	qword ptr [r12 + rax + 0x20], xmm0
               	test	dil, 0x7
               	jne	 <L238>
               	jmp	 <L239>
               	lea	rax, [rsi + 2*rsi]
...
<L243>:
               	...
               	vmovss	dword ptr [r12 + rax + 0x20], xmm0
<L235>:
               	test	dil, 0x7
               	jne	 <L238>
               	jmp	 <L239>
...
<L239>:
               	...
               	xor	rcx, qword ptr [rsp + 0x330]
               	mov	qword ptr [rsp + 0x8], rcx
               	mov	rcx, qword ptr [rsp + 0x228]
               	xor	rcx, qword ptr [rsp + 0x310]
               	mov	qword ptr [rsp + 0x228], rcx
               	mov	rcx, qword ptr [rsp + 0x8]
               	xor	qword ptr [rsp + 0x310], rcx
...
<L234>:
               	...
               	mov	rdi, r12
               	vzeroupper
               	call	 <auto Bodies3D::TransformReduce@Evaluation.Dependency.TransformReduce<Visitor::ObjectValue@Evaluation.Dependency.Visitor.ObjectValue<40ul, (std::align_val_t)8>*, Visitor::ObjectValue@Evaluation.Dependency.Visitor.ObjectValue<40ul, (std::align_val_t)8>*, ComputeVolumeSum(PseudoRandomSequence@Evaluation.Dependency.PseudoRandomSequence)::'lambda'(Visitor::ObjectReference@Evaluation.Dependency.Visitor.ObjectReference)>(Visitor::ObjectValue@Evaluation.Dependency.Visitor.ObjectValue<40ul, (std::align_val_t)8>*, Visitor::ObjectValue@Evaluation.Dependency.Visitor.ObjectValue<40ul, (std::align_val_t)8>*, ComputeVolumeSum(PseudoRandomSequence@Evaluation.Dependency.PseudoRandomSequence)::'lambda'(Visitor::ObjectReference@Evaluation.Dependency.Visitor.ObjectReference))>
...
<auto Bodies3D::TransformReduce@Evaluation.Dependency.TransformReduce<Visitor::ObjectValue@Evaluation.Dependency.Visitor.ObjectValue<40ul, (std::align_val_t)8>*, Visitor::ObjectValue@Evaluation.Dependency.Visitor.ObjectValue<40ul, (std::align_val_t)8>*, ComputeVolumeSum(PseudoRandomSequence@Evaluation.Dependency.PseudoRandomSequence)::'lambda'(Visitor::ObjectReference@Evaluation.Dependency.Visitor.ObjectReference)>(Visitor::ObjectValue@Evaluation.Dependency.Visitor.ObjectValue<40ul, (std::align_val_t)8>*, Visitor::ObjectValue@Evaluation.Dependency.Visitor.ObjectValue<40ul, (std::align_val_t)8>*, ComputeVolumeSum(PseudoRandomSequence@Evaluation.Dependency.PseudoRandomSequence)::'lambda'(Visitor::ObjectReference@Evaluation.Dependency.Visitor.ObjectReference))>:
<L2>:
               	push	r15
               	push	r14
               	push	r13
               	...
               	cmp	r14, 0x30
               	jne	 <L0>
               	vmovss	xmm0, dword ptr  <__libc_start_main+0xb48> # xmm0 = mem[0],zero,zero,zero
               	jmp	 <L1>
<L0>:
               	mov	rbx, rsi
               	vmovss	xmm0, dword ptr  <__libc_start_main+0xb48> # xmm0 = mem[0],zero,zero,zero
               	movabs	r13, -0x2aaaaaaaaaaaaaab
               	mov	rdi, r15
               	nop
<L3>:
...
<L1>:
               	...
               	lea	rcx,  <void Visitor::ObjectValue@Evaluation.Dependency.Visitor.ObjectValue<40ul, (std::align_val_t)8>::Delete<Bodies3D::Ellipsoid@Evaluation.CRTP.Ellipsoid>(void*)>
               	cmp	rdx, rcx
               	vmovss	xmm2, dword ptr [rsp + 0xc] # xmm2 = mem[0],zero,zero,zero
               	je	 <L5>
               	lea	rcx,  <void Visitor::ObjectValue@Evaluation.Dependency.Visitor.ObjectValue<40ul, (std::align_val_t)8>::Delete<Bodies3D::Ellipsoid@Evaluation.CRTP.Ellipsoid>(void*)>
               	cmp	rdx, rcx
               	je	 <L6>
...
<L12>:
               	...
               	vmulss	xmm1, xmm1, dword ptr  <__libc_start_main+0xb4c>
               	vmulss	xmm0, xmm1, xmm0
               	jmp	 <L16>
<L4>:
               	vmovss	xmm0, dword ptr [rax + 0x1c] # xmm0 = mem[0],zero,zero,zero
               	vmulss	xmm0, xmm0, xmm0
               	vmulss	xmm0, xmm0, dword ptr  <__libc_start_main+0xb3c>
               	vmovss	xmm2, dword ptr [rsp + 0xc] # xmm2 = mem[0],zero,zero,zero
               	jmp	 <L16>
<L5>:
               	vmovss	xmm0, dword ptr [rax + 0x1c] # xmm0 = mem[0],zero,zero,zero
...
<L8>:
               	vmovss	xmm0, dword ptr [rax + 0x1c] # xmm0 = mem[0],zero,zero,zero
               	vmulss	xmm0, xmm0, dword ptr  <__libc_start_main+0xb44>
               	jmp	 <L17>
<L9>:
               	vmovss	xmm0, dword ptr [rax + 0x1c] # xmm0 = mem[0],zero,zero,zero
               	vmulss	xmm1, xmm0, xmm0
...
<L11>:
               	vmovss	xmm0, dword ptr [rax + 0x1c] # xmm0 = mem[0],zero,zero,zero
               	vmulss	xmm0, xmm0, dword ptr  <__libc_start_main+0xb40>
<L20>:
               	vmulss	xmm0, xmm0, dword ptr [rax + 0x20]
<L18>:
...
<L14>:
               	vmovss	xmm0, dword ptr [rax + 0x1c] # xmm0 = mem[0],zero,zero,zero
               	vmulss	xmm0, xmm0, xmm0
               	vmulss	xmm0, xmm0, dword ptr  <__libc_start_main+0xb38>
               	jmp	 <L17>
<L15>:
               	vmovss	xmm0, dword ptr [rax + 0x1c] # xmm0 = mem[0],zero,zero,zero
               	vmulss	xmm0, xmm0, dword ptr  <__libc_start_main+0xb4c>
               	jmp	 <L20>
               	int3
               	int3
               	int3
...
<_init>:
               	endbr64
               	sub	rsp, 0x8
               	mov	rax, qword ptr  <__libc_start_main+0x6ad8>
               	test	rax, rax
               	je	 <L0>
               	call	rax
<L0>:
