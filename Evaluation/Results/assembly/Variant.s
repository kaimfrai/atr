...
<_start>:
               	...
               	xor	ecx, ecx
               	lea	rdi,  <main>
               	call	qword ptr  <__libc_start_main+0x6d50>
               	hlt
               	int3
               	int3
               	int3
...
<deregister_tm_clones>:
               	...
               	cmp	rax, rdi
               	je	 <L0>
               	mov	rax, qword ptr  <__libc_start_main+0x6d60>
               	test	rax, rax
               	je	 <L0>
               	jmp	rax
               	nop	dword ptr [rax]
...
<register_tm_clones>:
               	...
               	sar	rsi
               	je	 <L0>
               	mov	rax, qword ptr  <__libc_start_main+0x6d68>
               	test	rax, rax
               	je	 <L0>
               	jmp	rax
...
<__do_global_dtors_aux>:
               	...
               	jne	 <L0>
               	push	rbp
               	cmp	qword ptr , 0x0 <__libc_start_main+0x6d70>
               	mov	rbp, rsp
               	je	 <L1>
...
<L2>:
               	...
               	movsxd	rax, ecx
               	imul	rdi, rax, 0x64
               	mov	rsi, qword ptr  <__libc_start_main+0x6d78>
...
<L238>:
               	...
               	vmovdqu	ymm9, ymmword ptr [rsp + 0x270]
               	vmovdqu	ymm10, ymmword ptr [rsp + 0x2b0]
               	vmovdqu	ymm11, ymmword ptr [rsp + 0x2d0]
               	vmovdqu	ymm12, ymmword ptr [rsp + 0x2f0]
               	vpsrlq	ymm9, ymm9, 0x8
               	vmovdqu	ymmword ptr [rsp + 0x270], ymm9
               	vpsrlq	ymm8, ymm8, 0x8
               	vmovdqu	ymmword ptr [rsp + 0x290], ymm8
               	vpsrlq	ymm8, ymm10, 0x8
               	vmovdqu	ymmword ptr [rsp + 0x2b0], ymm8
               	vpsrlq	ymm8, ymm11, 0x8
               	vmovdqu	ymmword ptr [rsp + 0x2d0], ymm8
               	vpsrlq	ymm10, ymm12, 0x8
               	vmovdqu	ymmword ptr [rsp + 0x2f0], ymm10
               	vmovq	r14, xmm9
...
<L244>:
               	...
               	je	 <L234>
<L233>:
               	vmovdqu	ymm8, ymmword ptr [rsp + 0x278]
               	...
               	vmovdqu	xmm11, xmmword ptr [rsp + 0x2b8]
               	...
               	jmp	rax
               	imul	rax, rcx, 0x64
               	mov	byte ptr [r15 + rax + 0x60], 0x0
               	jmp	 <L236>
               	imul	rax, rcx, 0x64
               	mov	byte ptr [r15 + rax + 0x60], 0xb
               	jmp	 <L237>
               	vpextrb	eax, xmm10, 0x7
               	imul	rsi, rcx, 0x64
               	vcvtsi2ss	xmm12, xmm15, eax
               	mov	byte ptr [r15 + rsi + 0x60], 0x4
               	inc	rcx
               	vmovss	dword ptr [r15 + rsi + 0x20], xmm12
               	...
               	vmovups	ymmword ptr [r15 + rsi], ymm10
               	test	dl, 0x7
               	jne	 <L238>
               	jmp	 <L239>
               	imul	rax, rcx, 0x64
               	mov	byte ptr [r15 + rax + 0x60], 0xc
               	inc	rcx
               	vpmovzxbd	ymm10, xmm10    # ymm10 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero,xmm10[2],zero,zero,zero,xmm10[3],zero,zero,zero,xmm10[4],zero,zero,zero,xmm10[5],zero,zero,zero,xmm10[6],zero,zero,zero,xmm10[7],zero,zero,zero
               	vcvtdq2ps	ymm10, ymm10
               	vpermilps	ymm11, ymm10, ymm3
               	vmovups	ymmword ptr [r15 + rax], ymm11
               	vmovdqu	xmm11, xmmword ptr [rsp + 0x2c8]
               	vpshufb	xmm11, xmm11, xmm6
               	vcvtdq2ps	xmm11, xmm11
               	movzx	esi, r12b
               	vcvtsi2ss	xmm12, xmm15, esi
               	vmovlps	qword ptr [r15 + rax + 0x20], xmm11
               	vmovss	dword ptr [r15 + rax + 0x28], xmm12
               	vshufps	xmm10, xmm10, xmm10, 0xff # xmm10 = xmm10[3,3,3,3]
               	vmovss	dword ptr [r15 + rax + 0x2c], xmm10
               	vmovups	xmm13, xmmword ptr [rsp + 0x2e0]
               	vshufps	xmm13, xmm13, xmmword ptr [rsp + 0x2f0], 0x88 # xmm13 = xmm13[0,2],mem[0,2]
               	vandps	xmm13, xmm13, xmm7
               	vcvtdq2ps	xmm13, xmm13
               	vshufps	xmm14, xmm13, xmm13, 0xd8 # xmm14 = xmm13[0,2,1,3]
               	vmovups	xmmword ptr [r15 + rax + 0x30], xmm14
               	vmovlps	qword ptr [r15 + rax + 0x40], xmm11
               	movzx	esi, bpl
               	vcvtsi2ss	xmm11, xmm15, esi
               	vmovss	dword ptr [r15 + rax + 0x48], xmm12
               	vmovss	dword ptr [r15 + rax + 0x4c], xmm10
               	vmovss	dword ptr [r15 + rax + 0x50], xmm11
               	vshufps	xmm10, xmm13, xmm13, 0xe6 # xmm10 = xmm13[2,1,2,3]
               	vmovlps	qword ptr [r15 + rax + 0x54], xmm10
               	vextractps	dword ptr [r15 + rax + 0x5c], xmm13, 0x3
               	test	dl, 0x7
               	jne	 <L238>
               	jmp	 <L239>
               	imul	rax, rcx, 0x64
               	mov	byte ptr [r15 + rax + 0x60], 0x9
               	jmp	 <L240>
               	imul	rax, rcx, 0x64
               	mov	byte ptr [r15 + rax + 0x60], 0x2
               	jmp	 <L241>
               	imul	rax, rcx, 0x64
               	mov	byte ptr [r15 + rax + 0x60], 0x3
               	jmp	 <L236>
               	imul	rax, rcx, 0x64
               	mov	byte ptr [r15 + rax + 0x60], 0x7
               	inc	rcx
...
<L242>:
               	...
               	vmovlps	qword ptr [r15 + rax + 0x20], xmm10
               	test	dl, 0x7
               	jne	 <L238>
               	jmp	 <L239>
               	imul	rax, rcx, 0x64
               	mov	byte ptr [r15 + rax + 0x60], 0xa
<L240>:
               	inc	rcx
               	vpmovzxbd	ymm10, xmm10    # ymm10 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero,xmm10[2],zero,zero,zero,xmm10[3],zero,zero,zero,xmm10[4],zero,zero,zero,xmm10[5],zero,zero,zero,xmm10[6],zero,zero,zero,xmm10[7],zero,zero,zero
               	vcvtdq2ps	ymm10, ymm10
...
<L243>:
               	...
               	vmovss	dword ptr [r15 + rax + 0x20], xmm10
<L235>:
               	test	dl, 0x7
               	jne	 <L238>
               	jmp	 <L239>
               	imul	rax, rcx, 0x64
               	mov	byte ptr [r15 + rax + 0x60], 0x8
<L236>:
               	inc	rcx
               	vpmovzxbd	ymm10, xmm10    # ymm10 = xmm10[0],zero,zero,zero,xmm10[1],zero,zero,zero,xmm10[2],zero,zero,zero,xmm10[3],zero,zero,zero,xmm10[4],zero,zero,zero,xmm10[5],zero,zero,zero,xmm10[6],zero,zero,zero,xmm10[7],zero,zero,zero
               	vcvtdq2ps	ymm10, ymm10
...
<L239>:
               	...
               	mov	rax, qword ptr [rsp + 0x200]
               	shl	rax, 0x11
               	xor	r9, qword ptr [rsp + 0x268]
               	mov	rsi, qword ptr [rsp + 0x228]
               	xor	rsi, qword ptr [rsp + 0x200]
...
<L250>:
               	...
               	mov	rsi, qword ptr  <__libc_start_main+0x6d80>
               	mov	rdi, rax
               	xor	edx, edx
...
<_init>:
               	endbr64
               	sub	rsp, 0x8
               	mov	rax, qword ptr  <__libc_start_main+0x6d58>
               	test	rax, rax
               	je	 <L0>
               	call	rax
<L0>:
