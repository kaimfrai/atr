...
<deregister_tm_clones>:
               	...
               	cmp	rax, rdi
               	je	 <L0>
               	mov	rax, qword ptr  <strcmp+0xa578>
               	test	rax, rax
               	je	 <L0>
               	jmp	rax
               	nop	dword ptr [rax]
...
<register_tm_clones>:
               	...
               	sar	rsi
               	je	 <L0>
               	mov	rax, qword ptr  <strcmp+0xa580>
               	test	rax, rax
               	je	 <L0>
               	jmp	rax
...
<__do_global_dtors_aux>:
               	...
               	jne	 <L0>
               	push	rbp
               	cmp	qword ptr , 0x0 <strcmp+0xa588>
               	mov	rbp, rsp
               	je	 <L1>
...
<L2>:
               	...
               	shl	rax, 0x3
               	lea	rdi, [rax + 4*rax]
               	mov	rsi, qword ptr  <strcmp+0xa590>
...
<L254>:
               	add	rbx, 0x18
               	mov	r15, qword ptr  <strcmp+0xa5a0>
...
<L264>:
               	...
               	mov	rsi, qword ptr  <strcmp+0xa598>
               	mov	rdi, rax
               	xor	edx, edx
...
<std::_Sp_counted_base<(__gnu_cxx::_Lock_policy)2>::_M_release_last_use_cold()>:
               	...
               	call	qword ptr [rax + 0x10]
               	mov	rax, qword ptr  <strcmp+0xa5a0>
...
<_init>:
               	endbr64
               	sub	rsp, 0x8
               	mov	rax, qword ptr  <strcmp+0xa570>
               	test	rax, rax
               	je	 <L0>
               	call	rax
<L0>:
