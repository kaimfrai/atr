...
<deregister_tm_clones>:
               	...
               	cmp	rax, rdi
               	je	 <L0>
               	mov	rax, qword ptr  <strcmp+0xa6b8>
               	test	rax, rax
               	je	 <L0>
               	jmp	rax
               	nop	dword ptr [rax]
...
<register_tm_clones>:
               	...
               	sar	rsi
               	je	 <L0>
               	mov	rax, qword ptr  <strcmp+0xa6c0>
               	test	rax, rax
               	je	 <L0>
               	jmp	rax
...
<__do_global_dtors_aux>:
               	...
               	jne	 <L0>
               	push	rbp
               	cmp	qword ptr , 0x0 <strcmp+0xa6c8>
               	mov	rbp, rsp
               	je	 <L1>
...
<L2>:
               	...
               	shl	rax, 0x3
               	lea	rdi, [rax + 2*rax]
               	mov	rsi, qword ptr  <strcmp+0xa6d8>
               	call	 <_ZnamRKSt9nothrow_t@plt>
               	movsxd	rdx, r14d
               	vmovq	xmm0, rdx
               	vpbroadcastq	ymm0, xmm0
               	vpsrlq	xmm1, xmm0, 0x1e
               	vpaddq	ymm2, ymm0, ymmword ptr  <strcmp+0x1900>
               	...
               	vpbroadcastq	ymm1, qword ptr  <strcmp+0x1958>
               	vpmuludq	ymm1, ymm0, ymm1
               	vpsrlq	ymm2, ymm0, 0x20
               	vpbroadcastq	ymm3, qword ptr  <strcmp+0x1940>
               	...
               	vpbroadcastq	ymm2, qword ptr  <strcmp+0x1948>
               	vpxor	ymm0, ymm1, ymm0
               	vpmuludq	ymm1, ymm0, ymm2
               	vpbroadcastq	ymm2, qword ptr  <strcmp+0x1950>
...
<L229>:
               	...
               	jmp	 <L231>
<L230>:
               	vmovdqu	ymm0, ymmword ptr [rsp + 0x3a0]
               	...
               	mov	qword ptr [rax + rbp - 0x10], rcx
               	mov	qword ptr [rax + rbp - 0x8], 0x0
               	mov	edi, 0x68
               	vzeroupper
               	call	 <_Znwm@plt>
               	vmovdqa	xmm0, xmmword ptr [rsp + 0x340]
               	vpshufb	xmm0, xmm0, xmmword ptr  <strcmp+0x1960>
               	movzx	ecx, r15b
               	vcvtsi2ss	xmm1, xmm6, ecx
               	vcvtdq2ps	xmm0, xmm0
               	vbroadcastss	ymm2, dword ptr  <strcmp+0x1980>
...
<L236>:
               	...
               	test	sil, 0x7
               	je	 <L234>
               	vpermq	ymm0, ymmword ptr [rsp + 0x380], 0x93 # ymm0 = mem[3,0,1,2]
...
<L234>:
               	...
               	xor	qword ptr [rsp + 0x258], rdx
               	rol	rdx, 0x2d
               	mov	qword ptr [rsp + 0xc0], rdx
               	vpxor	xmm0, xmm0, xmm3
               	xor	qword ptr [rsp + 0x250], r13
               	rol	r13, 0x2d
               	mov	qword ptr [rsp + 0x108], r13
               	mov	r13, qword ptr [rsp + 0x20]
               	vpbroadcastq	ymm1, xmm1
               	xor	qword ptr [rsp + 0x248], r14
               	rol	r14, 0x2d
               	mov	qword ptr [rsp + 0xf8], r14
               	mov	r14, qword ptr [rsp + 0x380]
...
<L233>:
               	mov	qword ptr [rsp + 0x8], rsi
               	vmovups	ymm0, ymmword ptr [rsp + 0x2b8]
               	vmovups	ymm1, ymmword ptr [rsp + 0x2c8]
               	vmovdqu	xmm2, xmmword ptr [rsp + 0x2e8]
               	vperm2f128	ymm3, ymm1, ymmword ptr [rsp + 0x2a8], 0x2 # ymm3 = mem[0,1],ymm1[0,1]
               	vinsertf128	ymm0, ymm0, xmmword ptr [rsp + 0x2d8], 0x1
               	vshufps	ymm0, ymm3, ymm0, 0x88  # ymm0 = ymm3[0,2],ymm0[0,2],ymm3[4,6],ymm0[4,6]
               	vandps	ymm0, ymm0, ymmword ptr  <strcmp+0x1920>
               	vcvtdq2ps	ymm0, ymm0
               	vmovups	ymmword ptr [rsp + 0x270], ymm0
               	vpshufb	xmm0, xmm2, xmmword ptr  <strcmp+0x1960>
               	vcvtdq2ps	xmm2, xmm0
               	movzx	ecx, al
               	imul	ecx, ecx, 0x4f
               	shr	ecx, 0xa
               	lea	edx, [rcx + 2*rcx]
               	lea	ecx, [rcx + 4*rdx]
               	vblendps	ymm0, ymm1, ymmword ptr [rsp + 0x2a8], 0xc0 # ymm0 = ymm1[0,1,2,3,4,5],mem[6,7]
               	vmovups	ymmword ptr [rsp + 0x380], ymm0
               	sub	al, cl
               	movzx	eax, al
               	lea	rcx,  <strcmp+0x199c>
               	...
               	jmp	 <L236>
               	vmovaps	xmmword ptr [rsp + 0x20], xmm2
               	mov	rax, qword ptr [rsp]
...
<L235>:
               	...
               	nop	word ptr cs:[rax + rax]
<L239>:
               	vmovd	xmm0, dword ptr [rsp + 0x2a4]
               	vmovd	dword ptr [rsp + 0x2a8], xmm0
               	mov	ebp, 0x1
<L247>:
               	mov	eax, ebp
               	lea	rdx, [4*rax + 0x4]
...
<L240>:
               	...
               	mov	rdx, rcx
               	and	rdx, -0x20
               	vpblendd	xmm0, xmm0, xmmword ptr , 0xe <strcmp+0x1970> # xmm0 = xmm0[0],mem[1,2,3]
               	lea	rsi, [rsp + 0x300]
               	lea	rsi, [rsi + 4*rax]
...
<L241>:
               	...
               	vmovd	dword ptr [rsp + 4*rax + 0x2a4], xmm0
               	mov	r15, rbx
               	test	ebp, ebp
               	jns	 <L247>
               	jmp	 <L238>
<L246>:
               	mov	r12, qword ptr [rsp + 0x298]
               	mov	r15, qword ptr [rsp]
               	mov	rbp, qword ptr [rsp + 0x340]
...
<L250>:
               	...
               	vucomiss	xmm0, dword ptr  <strcmp+0x1994>
               	jne	 <L252>
<L251>:
               	xor	eax, eax
               	add	rsp, 0x3c8
...
<L252>:
               	...
               	mov	rsi, qword ptr  <strcmp+0xa6e0>
               	mov	rdi, rax
               	xor	edx, edx
...
<Bodies3D::AnyBody::AnyBody<Bodies3D::Head@Evaluation.CRTP.Head, RGBAColor@Evaluation.Dependency.CommonData const&, Point@Evaluation.Dependency.CommonData const&, float const&, Bodies3D::Sphere@Evaluation.CRTP.Sphere, Bodies3D::Sphere@Evaluation.CRTP.Sphere>(std::in_place_type_t<Bodies3D::Head@Evaluation.CRTP.Head>, RGBAColor@Evaluation.Dependency.CommonData const&, Point@Evaluation.Dependency.CommonData const&, float const&, Bodies3D::Sphere@Evaluation.CRTP.Sphere&&, Bodies3D::Sphere@Evaluation.CRTP.Sphere&&)::'lambda'(std::any const&)::__invoke(std::any const&)>:
               	...
               	jmp	 <L0>
<L1>:
               	mov	rax, qword ptr  <strcmp+0xa6e8>
               	mov	rdi, qword ptr [rax + 0x8]
               	lea	rax,  <typeinfo name for Bodies3D::BodyAdapter<Bodies3D::Head@Evaluation.CRTP.Head>>
               	cmp	rdi, rax
               	je	 <L0>
...
<std::__throw_bad_any_cast()>:
               	...
               	mov	rdx, qword ptr  <strcmp+0xa6d0>
               	mov	rdi, rax
               	call	 <__cxa_throw@plt>
               	int3
               	int3
...
<Bodies3D::BodyAdapter<Bodies3D::Sphere@Evaluation.CRTP.Sphere>::ComputeVolume() const>:
               	...
               	vmulss	xmm1, xmm1, dword ptr  <strcmp+0x1998>
...
<Bodies3D::BodyAdapter<Bodies3D::Ellipsoid@Evaluation.CRTP.Ellipsoid>::ComputeVolume() const>:
               	vmovss	xmm0, dword ptr [rdi + 0x24]
               	vmulss	xmm0, xmm0, dword ptr  <strcmp+0x1998>
...
<Bodies3D::BodyAdapter<Bodies3D::Cone@Evaluation.CRTP.Cone>::ComputeVolume() const>:
               	...
               	vmulss	xmm0, xmm0, dword ptr  <strcmp+0x1984>
               	vmulss	xmm0, xmm0, dword ptr [rdi + 0x28]
               	ret
               	int3
               	int3
...
<Bodies3D::BodyAdapter<Bodies3D::Cylinder@Evaluation.CRTP.Cylinder>::ComputeVolume() const>:
               	vmovss	xmm0, dword ptr [rdi + 0x24]
               	vmulss	xmm0, xmm0, xmm0
               	vmulss	xmm0, xmm0, dword ptr  <strcmp+0x1988>
               	vmulss	xmm0, xmm0, dword ptr [rdi + 0x28]
               	ret
               	int3
               	int3
...
<Bodies3D::BodyAdapter<Bodies3D::Pyramid@Evaluation.CRTP.Pyramid>::ComputeVolume() const>:
               	vmovss	xmm0, dword ptr [rdi + 0x24]
               	vmulss	xmm0, xmm0, dword ptr  <strcmp+0x198c>
               	vmulss	xmm0, xmm0, dword ptr [rdi + 0x28]
               	vmulss	xmm0, xmm0, dword ptr [rdi + 0x2c]
               	ret
               	int3
...
<Bodies3D::BodyAdapter<Bodies3D::Triangle@Evaluation.CRTP.Triangle>::ComputeVolume() const>:
               	vmovss	xmm0, dword ptr [rdi + 0x24]
               	vmulss	xmm0, xmm0, dword ptr  <strcmp+0x1990>
               	vmulss	xmm0, xmm0, dword ptr [rdi + 0x28]
               	ret
               	int3
               	int3
...
<_init>:
               	endbr64
               	sub	rsp, 0x8
               	mov	rax, qword ptr  <strcmp+0xa6b0>
               	test	rax, rax
               	je	 <L0>
               	call	rax
<L0>:
