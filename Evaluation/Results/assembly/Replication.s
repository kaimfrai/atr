...
<_start>:
               	...
               	xor	ecx, ecx
               	lea	rdi,  <main>
               	call	qword ptr  <__libc_start_main+0x6580>
               	hlt
               	int3
               	int3
               	int3
...
<deregister_tm_clones>:
               	...
               	cmp	rax, rdi
               	je	 <L0>
               	mov	rax, qword ptr  <__libc_start_main+0x6590>
               	test	rax, rax
               	je	 <L0>
               	jmp	rax
               	nop	dword ptr [rax]
...
<register_tm_clones>:
               	...
               	sar	rsi
               	je	 <L0>
               	mov	rax, qword ptr  <__libc_start_main+0x6598>
               	test	rax, rax
               	je	 <L0>
               	jmp	rax
...
<__do_global_dtors_aux>:
               	...
               	jne	 <L0>
               	push	rbp
               	cmp	qword ptr , 0x0 <__libc_start_main+0x65a0>
               	mov	rbp, rsp
               	je	 <L1>
...
<L2>:
               	...
               	shl	rax, 0x3
               	lea	rdi, [rax + 8*rax]
               	mov	rsi, qword ptr  <__libc_start_main+0x65a8>
...
<L230>:
               	...
               	xor	edx, edx
               	vpbroadcastw	xmm2, word ptr  <__libc_start_main+0x98c>
               	lea	rbx,  <__libc_start_main+0x990>
...
<L244>:
               	...
               	mov	rdi, r14
               	vzeroupper
               	call	 <auto Bodies3D::TransformReduce@Evaluation.Dependency.TransformReduce<Bodies3D::VolumeComputer*, Bodies3D::VolumeComputer*, ComputeVolumeSum(PseudoRandomSequence@Evaluation.Dependency.PseudoRandomSequence)::'lambda'(Bodies3D::VolumeComputer const&)>(Bodies3D::VolumeComputer*, Bodies3D::VolumeComputer*, ComputeVolumeSum(PseudoRandomSequence@Evaluation.Dependency.PseudoRandomSequence)::'lambda'(Bodies3D::VolumeComputer const&))>
               	test	r14, r14
               	je	 <L245>
               	mov	rdi, r14
...
<L245>:
               	...
               	cmp	rbx, rax
               	jne	 <L246>
               	vucomiss	xmm0, dword ptr  <__libc_start_main+0x980>
               	jb	 <L247>
               	vucomiss	xmm0, dword ptr  <__libc_start_main+0x988>
               	ja	 <L247>
<L246>:
               	xor	eax, eax
               	add	rsp, 0x328
...
<L247>:
               	...
               	mov	rsi, qword ptr  <__libc_start_main+0x65b0>
               	mov	rdi, rax
               	xor	edx, edx
...
<auto Bodies3D::TransformReduce@Evaluation.Dependency.TransformReduce<Bodies3D::VolumeComputer*, Bodies3D::VolumeComputer*, ComputeVolumeSum(PseudoRandomSequence@Evaluation.Dependency.PseudoRandomSequence)::'lambda'(Bodies3D::VolumeComputer const&)>(Bodies3D::VolumeComputer*, Bodies3D::VolumeComputer*, ComputeVolumeSum(PseudoRandomSequence@Evaluation.Dependency.PseudoRandomSequence)::'lambda'(Bodies3D::VolumeComputer const&))>:
<L2>:
               	push	r15
               	push	r14
               	push	r13
               	...
               	cmp	r14, 0x48
               	jne	 <L0>
               	vmovss	xmm0, dword ptr  <__libc_start_main+0x97c> # xmm0 = mem[0],zero,zero,zero
...
<Bodies3D::ComputeVolumeSphere@Evaluation.Replication.Sphere(void const*)>:
               	vmovss	xmm0, dword ptr [rdi + 0x1c] # xmm0 = mem[0],zero,zero,zero
               	vmulss	xmm1, xmm0, xmm0
               	vmulss	xmm1, xmm1, dword ptr  <__libc_start_main+0x984>
               	vmulss	xmm0, xmm1, xmm0
               	ret
               	int3
               	int3
...
<Bodies3D::ComputeVolumeEllipsoid@Evaluation.Replication.Ellipsoid(void const*)>:
               	vmovss	xmm0, dword ptr [rdi + 0x1c] # xmm0 = mem[0],zero,zero,zero
               	vmulss	xmm0, xmm0, dword ptr  <__libc_start_main+0x984>
               	vmulss	xmm0, xmm0, dword ptr [rdi + 0x20]
               	vmulss	xmm0, xmm0, dword ptr [rdi + 0x24]
               	ret
...
<_init>:
               	endbr64
               	sub	rsp, 0x8
               	mov	rax, qword ptr  <__libc_start_main+0x6588>
               	test	rax, rax
               	je	 <L0>
               	call	rax
<L0>:
