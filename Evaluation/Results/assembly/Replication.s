...
<_start>:
               	...
               	xor	ecx, ecx
               	lea	rdi,  <main>
               	call	qword ptr  <__libc_start_main+0x6508>
               	hlt
               	int3
               	int3
               	int3
...
<deregister_tm_clones>:
               	...
               	cmp	rax, rdi
               	je	 <L0>
               	mov	rax, qword ptr  <__libc_start_main+0x6518>
               	test	rax, rax
               	je	 <L0>
               	jmp	rax
               	nop	dword ptr [rax]
...
<register_tm_clones>:
               	...
               	sar	rsi
               	je	 <L0>
               	mov	rax, qword ptr  <__libc_start_main+0x6520>
               	test	rax, rax
               	je	 <L0>
               	jmp	rax
...
<__do_global_dtors_aux>:
               	...
               	jne	 <L0>
               	push	rbp
               	cmp	qword ptr , 0x0 <__libc_start_main+0x6528>
               	mov	rbp, rsp
               	je	 <L1>
...
<L2>:
               	...
               	shl	rax, 0x3
               	lea	rdi, [rax + 8*rax]
               	mov	rsi, qword ptr  <__libc_start_main+0x6530>
...
<L235>:
               	...
               	lea	rax, [rsi + 8*rsi]
               	lea	r8,  <Bodies3D::ComputeVolumeEllipsoid@Evaluation.Replication.Ellipsoid(void const*)>
               	jmp	 <L239>
               	mov	r8, qword ptr [rsp]
               	lea	rax, [r8 + 8*r8]
               	...
               	mov	rsi, qword ptr [rsp]
               	lea	rax, [rsi + 8*rsi]
               	lea	r8,  <Bodies3D::ComputeVolumeSphere@Evaluation.Replication.Sphere(void const*)>
               	...
               	mov	rsi, qword ptr [rsp]
               	lea	rax, [rsi + 8*rsi]
               	lea	r8,  <Bodies3D::ComputeVolumeCylinder@Evaluation.Replication.Cylinder(void const*)>
               	jmp	 <L243>
               	mov	r8, qword ptr [rsp]
               	lea	rax, [r8 + 8*r8]
...
<L238>:
               	...
               	mov	rsi, qword ptr [rsp]
               	lea	rax, [rsi + 8*rsi]
               	lea	r8,  <Bodies3D::ComputeVolumePyramid@Evaluation.Replication.Pyramid(void const*)>
               	jmp	 <L239>
               	mov	r8, qword ptr [rsp]
               	lea	rax, [r8 + 8*r8]
...
<L240>:
               	...
               	mov	rsi, qword ptr [rsp]
               	lea	rax, [rsi + 8*rsi]
               	lea	r8,  <Bodies3D::ComputeVolumeCube@Evaluation.Replication.Cube(void const*)>
               	jmp	 <L246>
               	mov	rsi, qword ptr [rsp]
               	lea	rax, [rsi + 8*rsi]
               	lea	r8,  <Bodies3D::ComputeVolumeCuboid@Evaluation.Replication.Cuboid(void const*)>
<L239>:
               	mov	qword ptr [r9 + 8*rax], r8
               	inc	rsi
               	mov	qword ptr [rsp], rsi
               	...
               	mov	rsi, qword ptr [rsp]
               	lea	rax, [rsi + 8*rsi]
               	lea	r8,  <Bodies3D::ComputeVolumeCone@Evaluation.Replication.Cone(void const*)>
<L243>:
               	mov	qword ptr [r9 + 8*rax], r8
               	inc	rsi
               	mov	qword ptr [rsp], rsi
...
<L262>:
               	...
               	mov	rsi, qword ptr  <__libc_start_main+0x6538>
               	mov	rdi, rax
               	xor	edx, edx
...
<_init>:
               	endbr64
               	sub	rsp, 0x8
               	mov	rax, qword ptr  <__libc_start_main+0x6510>
               	test	rax, rax
               	je	 <L0>
               	call	rax
<L0>:
