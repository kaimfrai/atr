...
if	(COMPILER_SEARCH_PATHS)
	set(CMAKE_C_COMPILER ${COMPILER_SEARCH_PATHS}/bin/clang-21)
	set(CMAKE_CXX_COMPILER ${COMPILER_SEARCH_PATHS}/bin/clang++-21)
else()
	find_program(CMAKE_C_COMPILER clang-21 REQUIRED)
	find_program(CMAKE_CXX_COMPILER clang++-21 REQUIRED)
