...
/// ****************************************************************************
static_assert
(	(p	and	(p	and	q	or	!p	and	!q	and	r))
==	(p	and	q)
);
static_assert
(	(!p	and	(p	and	q	or	!p	and	!q	and	r))
...
static_assert
(	(q	and	(p	and	q	or	!p	and	!q	and	r))
==	(q	and	p)
);
static_assert
(	(!q	and	(p	and	q	or	!p	and	!q	and	r))
...
/// ****************************************************************************
static_assert
(	(p	and	(p	and	q	and	r	or	!p	and	!q	and	r))
==	(p	and	q	and	r)
);
static_assert
(	(!p	and	(p	and	q	and	r	or	!p	and	!q	and	r))
...
static_assert
(	(q	and	(p	and	q	and	r	or	!p	and	!q	and	r))
==	(q	and	p	and	r)
);
static_assert
(	(!q	and	(p	and	q	and	r	or	!p	and	!q	and	r))
...
static_assert
(	(r	and	(p	and	q	and	r	or	!p	and	!q	and	r))
==	(r	and	p	and	q	or	r	and	!p	and	!q)
);
static_assert
(	(!r	and	(p	and	q	and	r	or	!p	and	!q	and	r))
...
/// ****************************************************************************
static_assert
(	(p	and	(p	and	q	or	p	and	r	or	!p	and	!q))
==	(p	and	q	or	p	and	r)
);
static_assert
(	(!p	and	(p	and	q	or	p	and	r	or	!p	and	!q))
...
static_assert
(	(q	and	(p	and	q	or	p	and	r	or	!p	and	!q))
==	(q	and	p)
);
static_assert
(	(!q	and	(p	and	q	or	p	and	r	or	!p	and	!q))
...
static_assert
(	(r	and	(p	and	q	or	p	and	r	or	!p	and	!q))
==	(r	and	p	or	r	and	!q)
);
static_assert
(	(!r	and	(p	and	q	or	p	and	r	or	!p	and	!q))
...
/// ****************************************************************************
static_assert
(	(p	and	(p	and	q	or	p	and	r or	!p	and	!q	or	!p	and	!r))
==	(p	and	q	or	p	and	r)
);
static_assert
(	(!p	and	(p	and	q	or	p	and	r or	!p	and	!q	or	!p	and	!r))
...
static_assert
(	(q	and	(p	and	q	or	p	and	r or	!p	and	!q	or	!p	and	!r))
==	(q	and	p	or	q	and	!r)
);
static_assert
(	(!q	and	(p	and	q	or	p	and	r or	!p	and	!q	or	!p	and	!r))
...
static_assert
(	(r	and	(p	and	q	or	p	and	r or	!p	and	!q	or	!p	and	!r))
==	(r	and	p	or	r	and	!q)
);
static_assert
(	(!r	and	(p	and	q	or	p	and	r or	!p	and	!q	or	!p	and	!r))
