...
/// ****************************************************************************
static_assert
(	(p	or	(p	and	q	and	r	or	!p	and	!q	and	r))
==	(p	or	!q	and	r)
);
static_assert
(	(!p	or	(p	and	q	and	r	or	!p	and	!q	and	r))
...
static_assert
(	(q	or	(p	and	q	and	r	or	!p	and	!q	and	r))
==	(q	or	!p	and	r)
);
static_assert
(	(!q	or	(p	and	q	and	r	or	!p	and	!q	and	r))
...
static_assert
(	(r	or	(p	and	q	and	r	or	!p	and	!q	and	r))
==	(r)
);
static_assert
(	(!r	or	(p	and	q	and	r	or	!p	and	!q	and	r))
...
/// ****************************************************************************
static_assert
(	(p	or	(p	and	q	or	p	and	r	or	!p	and	!q))
==	(p	or	!q)
);
static_assert
(	(!p	or	(p	and	q	or	p	and	r	or	!p	and	!q))
...
static_assert
(	(q	or	(p	and	q	or	p	and	r	or	!p	and	!q))
==	(q	or	r	or	!p)
);
static_assert
(	(!q	or	(p	and	q	or	p	and	r	or	!p	and	!q))
...
static_assert
(	(r	or	(p	and	q	or	p	and	r	or	!p	and	!q))
==	(r	or	p	and	q	or	!p	and	!q)
);
static_assert
(	(!r	or	(p	and	q	or	p	and	r	or	!p	and	!q))
...
/// ****************************************************************************
static_assert
(	(p	or	(p	and	q	or	p	and	r or	!p	and	!q	or	!p	and	!r))
==	(p	or	!q	or	!r)
);
static_assert
(	(!p	or	(p	and	q	or	p	and	r or	!p	and	!q	or	!p	and	!r))
...
static_assert
(	(q	or	(p	and	q	or	p	and	r or	!p	and	!q	or	!p	and	!r))
==	(q	or	r	or	!p)
);
static_assert
(	(!q	or	(p	and	q	or	p	and	r or	!p	and	!q	or	!p	and	!r))
...
static_assert
(	(r	or	(p	and	q	or	p	and	r or	!p	and	!q	or	!p	and	!r))
==	(r	or	q	or	!p)
);
static_assert
(	(!r	or	(p	and	q	or	p	and	r or	!p	and	!q	or	!p	and	!r))
